 ...
 * Louisa storefront (Template 9) — forked from honey / wire-and-bead. See PLAN-09-LOUISA.md.
 */
...
const DEFAULT_COMPANY_SLUG = process.env.NEXT_PUBLIC_COMPANY_SLUG || 'louisa'
