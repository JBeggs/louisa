// TypeScript types — Louisa multi-tenant storefront (Template 9, PLAN-09-LOUISA.md)
...
export interface Product {
  ...
  images?: ProductImage[]
  tags?: string[] | Tag[]
  /** Optional 0–5 heat indicator from API (Template 9). */
  spice_level?: number | null
  /** When true, cart/checkout favour store collect (Template 9 — requires backend field). */
  pickup_only?: boolean
